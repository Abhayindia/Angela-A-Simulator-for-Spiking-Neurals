'''
Tests the angela2.parsing package
'''
...
from angela2.core.variables import Constant
from angela2.groups.group import Group
from angela2.units.fundamentalunits import Dimension, DIMENSIONLESS
from angela2.utils.stringtools import get_identifiers, deindent
from angela2.utils.logger import std_silent
from angela2.parsing.rendering import (NodeRenderer, NumpyNodeRenderer,
                                      CPPNodeRenderer,
                                      )
from angela2.parsing.dependencies import abstract_code_dependencies
from angela2.parsing.expressions import (is_boolean_expression,
                                        parse_expression_dimensions,
                                        _get_value_from_expression)
from angela2.parsing.sympytools import str_to_sympy, sympy_to_str
from angela2.parsing.functions import (abstract_code_from_function,
                                      extract_abstract_code_functions,
                                      substitute_abstract_code_functions,)
from angela2.units import (volt, amp, DimensionMismatchError,
