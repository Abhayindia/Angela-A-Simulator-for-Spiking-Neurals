...
from angela2.core.variables import ArrayVariable, Variable, Constant
...
def test_check_for_invalid_values_linear_integrator():
    ...
    G.x = 1
    angelaLogger._log_messages.clear() # because the log message is set to be shown only once
