...
from angela2.codegen.generators import NumpyCodeGenerator
from angela2.core.network import schedule_propagation_offset
from angela2.core.variables import variables_by_owner, ArrayVariable, Constant
...
from angela2.utils.stringtools import get_identifiers, word_substitute, indent, deindent
from angela2.devices.device import reinit_and_delete, all_devices, get_device
from angela2.codegen.permutation_analysis import check_for_order_independence, OrderDependenceError
...
def test_connection_string_deterministic_multiple_and():
    # In angela versions 2.1.0-2.1.2, this fails on the numpy target
        ...
        try:
            ...
            with catch_logs(log_level=logging.INFO) as caught_logs:
                ...
                numpy_generator_messages = [l for l in caught_logs
                                            if l[1]=='angela2.codegen.generators.numpy_generator']
                if should_be_able_to_use_ufunc_at:
