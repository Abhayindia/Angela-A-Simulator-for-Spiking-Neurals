...
from angela2.core.variables import (Variables, LinkedVariable,
                                   DynamicArrayVariable, Subexpression)
from angela2.equations.equations import (Equations, DIFFERENTIAL_EQUATION,
                                        SUBEXPRESSION, PARAMETER,
                                        check_subexpressions,
                                        extract_constant_subexpressions)
from angela2.equations.refractory import add_refractoriness
from angela2.parsing.expressions import (parse_expression_dimensions,
                                        is_boolean_expression)
from angela2.stateupdaters.base import StateUpdateMethod
from angela2.units.allunits import second
from angela2.units.fundamentalunits import (Quantity, Unit, DIMENSIONLESS,
                                           have_same_dimensions,
                                           DimensionMismatchError,
                                           fail_for_dimension_mismatch)
from angela2.utils.logger import get_logger
from angela2.utils.stringtools import get_identifiers
...
def _guess_membrane_potential(equations):
    ...
    potential. This follows the same logic as in angela1 but is only used to
    give a suggestion in the error message when a angela1-style syntax is used
...
def to_start_stop(item, N):
    ...
    Examples
    --------
    >>> from angela2.groups.neurongroup import to_start_stop
