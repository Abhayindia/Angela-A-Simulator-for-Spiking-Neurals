...
from angela2.core.base import angelaObject, weakproxy_with_fallback
from angela2.core.names import Nameable
from angela2.core.preferences import prefs
from angela2.core.variables import (Variables, Constant, Variable,
...
from angela2.codegen.generators.numpy_generator import NumpyCodeGenerator
from angela2.equations.equations import BOOLEAN, INTEGER, FLOAT, Equations
from angela2.units.fundamentalunits import (fail_for_dimension_mismatch, Unit,
                                           get_unit, DIMENSIONLESS)
from angela2.utils.logger import get_logger
from angela2.utils.stringtools import get_identifiers, SpellChecker
from angela2.importexport.importexport import ImportExport
...
class VariableOwner(Nameable):
    ...
    def add_attribute(self, name):
        ...
        assigning to the new attribute name is necessary because angela will
...
class Group(VariableOwner, angelaObject):
...
class CodeRunner(angelaObject):
    ...
    def __init__(self, group, template, code='', user_code=None,
        ...
        angelaObject.__init__(self, clock=clock, dt=dt, when=when, order=order,
                             name=name)
