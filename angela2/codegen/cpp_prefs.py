...
Preferences
--------------------
.. document_angela_prefs:: codegen.cpp
...
if platform.system() == 'Windows':
    ...
    user_dir = os.path.join(os.path.expanduser('~'), '.angela')
...
prefs.register_preferences(
    ...
    extra_compile_args_msvc=angelaPreference(
    ...
    extra_link_args=angelaPreference(
        default=[],
        docs='''
    ...
    runtime_library_dirs=angelaPreference(
        default=[],
        docs='''
        List of directories to search for C/C++ libraries at run time.
        '''
    ),
    libraries=angelaPreference(
        default=[],
        docs='''
        List of library names (not filenames or paths) to link against.
        '''
    ),
    headers=angelaPreference(
        default=[],
        docs='''
    ...
    define_macros=angelaPreference(
        default=[],
        docs='''
