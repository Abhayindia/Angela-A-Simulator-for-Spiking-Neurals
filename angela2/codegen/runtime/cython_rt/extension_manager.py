...
from angela2.utils.logger import std_silent, get_logger
from angela2.utils.stringtools import deindent
from angela2.utils.filelock import FileLock
...
def get_cython_cache_dir():
    ...
    if cache_dir is None and Cython is not None:
        cache_dir = os.path.join(base_cython_cache_dir(), 'angela_extensions')
    return cache_dir
...
class CythonExtensionManager(object):
    ...
    def _load_module(self, module_path, define_macros, include_dirs, library_dirs,
        ...
        if not have_module:
            ...
            import angela2.synapses as synapses
