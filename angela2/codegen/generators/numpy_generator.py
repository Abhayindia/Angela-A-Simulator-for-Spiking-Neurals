...
from angela2.parsing.bast import angela_dtype_from_dtype
from angela2.parsing.rendering import NumpyNodeRenderer
from angela2.core.functions import DEFAULT_FUNCTIONS, timestep
from angela2.core.variables import ArrayVariable
from angela2.utils.stringtools import get_identifiers, word_substitute, indent
...
class NumpyCodeGenerator(CodeGenerator):
    ...
    def translate_statement(self, statement):
        ...
        if (statement.used_boolean_variables is not None and len(statement.used_boolean_variables)==1
                and angela_dtype_from_dtype(statement.dtype)=='float'
    ...
    def ufunc_at_vectorisation(self, statement, variables, indices,
        ...
        from angela2.devices.device import device

        # See https://github.com/angela-team/angela2/pull/531 for explanation
...
# otherwise angela would *add* units during simulation, thinking that the
