...
from angela2.utils.stringtools import (deindent, stripped_deindented_lines,
                                      word_substitute)
...
pow_support_code = '''
#ifdef _MSC_VER
#define _angela_pow(x, y) (pow((double)(x), (y)))
#else
#define _angela_pow(x, y) (pow((x), (y)))
#endif
'''
