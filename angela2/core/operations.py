...
class NetworkOperation(angelaObject):
    ...
    network_operation, Network, angelaObject
    """
    add_to_magic_network = True
    def __init__(self, function, dt=None, clock=None, when='start', order=0, name='networkoperation*'):
        angelaObject.__init__(self, dt=dt, clock=clock, when=when, order=order, name=name)
...
def network_operation(*args, **kwds):
    ...
    NetworkOperation, Network, angelaObject
    """
