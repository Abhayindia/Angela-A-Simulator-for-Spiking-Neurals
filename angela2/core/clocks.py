...
from angela2.groups.group import VariableOwner
from angela2.units.fundamentalunits import check_units, Quantity, DIMENSIONLESS
...
class DefaultClockProxy(object):
    ...
    def __getattr__(self, name):
        if name == '_is_proxy':
            return True
        from angela2.devices.device import active_device
