...
from angela2.units.fundamentalunits import (Quantity, get_unit, DIMENSIONLESS,
...
from angela2.utils.caching import CacheKey
...
class VariableView(object):
    ...
    def get_item(self, item, level=0, namespace=None):
        ...
        '''
        from angela2.core.namespace import get_local_namespace  # avoids circular import
