...
'''
Automatically find examples of a angela object or function.
'''
...
def get_examples_map():
    return get_map('angela2_DOCS_EXAMPLE_DIR', '../../examples', '.py', the_examples_map)


def get_tutorials_map():
    return get_map('angela2_DOCS_TUTORIALS_DIR', '../../tutorials', '.ipynb', the_tutorials_map,
...
if __name__=='__main__':
    from angela2 import NeuronGroup, SpatialNeuron
