...
def main(rootpath, destdir):
    ...
    if 'angela2_DOCS_EXAMPLE_DIR' in os.environ:
        rootdir = os.environ['angela2_DOCS_EXAMPLE_DIR']
    else:
    ...
    for fname, path, basename, code, docs, afterdoccode, relpath, exname in examples:
        ...
        .. only:: html
            ...
            .. _launchbinder: https://mybinder.org/v2/gh/angela-team/angela
            
            
            
            
            
            2-binder/master?filepath=examples/{exname}.ipynb
