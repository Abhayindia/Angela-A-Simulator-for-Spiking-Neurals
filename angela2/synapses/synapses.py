...
from angela2.core.base import weakproxy_with_fallback
from angela2.core.base import device_override
from angela2.core.namespace import get_local_namespace
from angela2.core.variables import (DynamicArrayVariable, Variables)
from angela2.codegen.codeobject import create_runner_codeobj
from angela2.codegen.translation import get_identifiers_recursively
from angela2.devices.device import get_device
from angela2.equations.equations import (Equations, SingleEquation,
                                        DIFFERENTIAL_EQUATION, SUBEXPRESSION,
                                        PARAMETER, INTEGER,
                                        check_subexpressions)
from angela2.groups.group import Group, CodeRunner, get_dtype
from angela2.groups.neurongroup import (extract_constant_subexpressions,
                                       SubexpressionUpdater,
                                       check_identifier_pre_post)
from angela2.parsing.expressions import is_boolean_expression, parse_expression_dimensions
from angela2.stateupdaters.base import (StateUpdateMethod,
                                       UnsupportedEquationsException)
from angela2.stateupdaters.exact import linear, independent
from angela2.units.fundamentalunits import (Quantity, DIMENSIONLESS, DimensionMismatchError,
...
from angela2.utils.arrays import calc_repeats
from angela2.core.spikesource import SpikeSource
from angela2.synapses.parse_synaptic_generator_syntax import parse_synapse_generator
from angela2.parsing.bast import angela_ast
from angela2.parsing.rendering import NodeRenderer
    ...
    def _check_parsed_synapses_generator(self, parsed, namespace):
        ...
        if parsed['iterator_func'] == 'range':
            ...
            for argname, arg in parsed['iterator_kwds'].items():
                ...
                annotated = angela_ast(arg, variables)
