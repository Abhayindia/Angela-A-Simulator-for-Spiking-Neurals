...
'''
Differential equations for angela models.
'''
...
from angela2.core.namespace import (DEFAULT_FUNCTIONS,
                                   DEFAULT_CONSTANTS,
                                   DEFAULT_UNITS)
from angela2.parsing.sympytools import sympy_to_str, str_to_sympy
from angela2.units.fundamentalunits import (Unit, Quantity, get_unit,
                                           get_unit_for_display,
                                           DIMENSIONLESS,
                                           DimensionMismatchError,
                                           get_dimensions, Dimension)
from angela2.units.allunits import (metre, meter, second, amp, ampere, kelvin, mole,
...
from angela2.utils.caching import cached, CacheKey
from angela2.utils.logger import get_logger
from angela2.utils.topsort import topsort
...
def parse_string_equations(eqns):
    ...
    equations : dict
        ...
        `~angela2.equations.equations.Equations` objects
    """
    equations = {}
