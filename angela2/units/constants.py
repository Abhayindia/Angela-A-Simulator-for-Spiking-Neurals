...
units are not imported by wildcard imports (e.g. `from angela2 import *`), they
have to be imported explicitly. You can use ``import ... as ...`` to import them
with shorter names, e.g.::

    from angela2.units.constants import faraday_constant as F

The available constants are:

==================== ================== ======================= ==================================================================
Constant             Symbol(s)          angela name              Value
==================== ================== ======================= ==================================================================
