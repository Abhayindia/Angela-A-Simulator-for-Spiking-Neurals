...
class GSLContainer(object):
    ...
    def __call__(self, obj):
        ...
        abstract_code : str
            ...
            by angela and used for later code generation in the `CodeGenerator.translate` method.
        '''
...
class GSLStateUpdater(StateUpdateMethod):
    ...
    def __call__(self, equations, variables=None, method_options=None):
        ...
        for diff_name, expr in diff_eqs:
            # if diff_name does not occur in the right hand side of the equation, angela does not
