...
from angela2.core.variables import Variables
from angela2.equations.equations import (Equations, PARAMETER, SUBEXPRESSION,
                                        DIFFERENTIAL_EQUATION, SingleEquation,
                                        extract_constant_subexpressions)
from angela2.groups.group import Group, CodeRunner, create_runner_codeobj
from angela2.units.allunits import ohm, siemens, amp, meter, volt
from angela2.units.fundamentalunits import (Quantity,
                                           fail_for_dimension_mismatch,
                                           have_same_dimensions,
                                           DimensionMismatchError)
from angela2.units.stdunits import uF, cm
from angela2.parsing.sympytools import sympy_to_str, str_to_sympy
from angela2.utils.logger import get_logger
from angela2.groups.neurongroup import (NeuronGroup, SubexpressionUpdater,
                                       to_start_stop)
from angela2.groups.subgroup import Subgroup
from angela2.equations.codestrings import Expression
...
class SpatialStateUpdater(CodeRunner, Group):
    ...
    def before_run(self, run_namespace):
        ...
        from angela2.codegen.runtime.numpy_rt.numpy_rt import NumpyCodeObject
