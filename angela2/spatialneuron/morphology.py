...
class MorphologyIndexWrapper(object):
    '''
    A simpler version of `~angela2.groups.group.IndexWrapper`, not allowing for
...
class Morphology(object, metaclass=abc.ABCMeta):
    ...
    def from_swc_file(filename, spherical_soma=True):
        ...
        the interpretation by angela is the type ``1`` which signals a soma.
