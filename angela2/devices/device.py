...
from angela2.memory.dynamicarray import DynamicArray, DynamicArray1D
from angela2.codegen.targets import codegen_targets
from angela2.codegen.runtime.numpy_rt import NumpyCodeObject
from angela2.core.names import find_name
from angela2.core.preferences import prefs
from angela2.core.variables import ArrayVariable, DynamicArrayVariable
from angela2.core.functions import Function
from angela2.units import ms
from angela2.utils.logger import get_logger
from angela2.utils.stringtools import code_representation, indent
...
class Device(object):
    ...
    def activate(self, build_on_run=True, **kwargs):
        ...
        '''
        from angela2.core.clocks import Clock  # avoid import issues
    ...
    def delete(self, data=True, code=True, directory=True, force=False):
        ...
        directory : bool, optional
            ...
            Will not delete directories that contain files not created by angela
            unless the ``force`` option is specfied. Defaults to ``True``.
        force : bool, optional
            Whether to delete the project directory with all its content, even
            if it contains files that were not created by angela. Useful only
...
class RuntimeDevice(Device):
    '''
    The default device used in angela, state variables are stored as numpy
    arrays in memory.
    '''
    def __init__(self):
    ...
    def spike_queue(self, source_start, source_end):
        ...
        try:
            from angela2.synapses.cythonspikequeue import SpikeQueue
            logger.diagnostic('Using the C++ SpikeQueue', once=True)
        except ImportError:
            from angela2.synapses.spikequeue import SpikeQueue
...
def reset_device(device=None):
    ...
    angela code and testing on various devices.
...
def reinit_devices():
    ...
    set again.
    '''
    from angela2 import restore_initial_state  # avoids circular import
