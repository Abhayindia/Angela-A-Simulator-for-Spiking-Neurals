...
# Make sure that angela's unit-aware functions are used, even when directly
# using names prefixed with numpy or np
import angela2.numpy_ as numpy
import angela2.numpy_ as np
...
from angela2.only import *
from angela2.only import test
...
def _check_caches():
    from angela2.codegen.runtime.cython_rt.extension_manager import get_cython_cache_dir
    from angela2.codegen.runtime.cython_rt.extension_manager import get_cython_extensions
