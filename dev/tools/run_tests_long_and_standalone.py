...
success = [angela2.test(long_tests=True, test_standalone='cpp_standalone', float_dtype=np.float32),
           angela2.test(long_tests=True, test_standalone='cpp_standalone', float_dtype=np.float64)]
